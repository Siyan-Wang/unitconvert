...
def test_unitconvert():
    ...
    # check temperature when fahrenheit equals to celsius at -40, they supposed to equal to each other
    Tf=-40.0
    Tc=-40.0
    ...
    # check conversion between miles and kilometers with some known results
    dm=2
    dk=100
